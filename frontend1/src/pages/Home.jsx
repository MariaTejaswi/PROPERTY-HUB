...
const Home = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Organize and respond to maintenance requests efficiently.",
    },
    {
    ...
    },
    {
      ...
      description: "Stay informed with automated reminders and alerts.",
    },
    {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-black">
      ...
      {/* Soft Overlay */}
      <div className="fixed inset-0 z-10 bg-gradient-to-b from-black/35 via-black/20 to-black/45 pointer-events-none"></div>
      ...
      <div className="relative z-20">
        ...
        <section className="h-screen flex flex-col justify-center items-center text-center text-white px-4">
          <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
            ...
            <span className="block mt-2 text-[#D4AF37]">Made Simple</span>
          </h1>
