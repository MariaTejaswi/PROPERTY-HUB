        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Modern property management made simple. Manage properties, tenants, payments, and maintenance all in one place.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/properties" className="text-sm hover:text-primary-400 transition-colors">
                  Properties
                </Link>
              </li>
              <li>
                <Link to="/payments" className="text-sm hover:text-primary-400 transition-colors">
                  Payments
                </Link>
              </li>
              <li>
                <Link to="/maintenance" className="text-sm hover:text-primary-400 transition-colors">
                  Maintenance
                </Link>
              </li>
              <li>
                <Link to="/leases" className="text-sm hover:text-primary-400 transition-colors">
                  Leases
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <EnvelopeIcon className="h-5 w-5 text-primary-400 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-sm">Email</p>
                  <a href="mailto:support@propertyhub.com" className="text-sm text-gray-400 hover:text-primary-400 transition-colors">
